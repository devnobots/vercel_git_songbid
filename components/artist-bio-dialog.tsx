  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent
          className="w-[90%] max-w-[400px] p-0 bg-[#f5f1e8] text-[#8b7355] rounded-xl overflow-hidden border-0"
          hideCloseButton={true}
        >
          <div className="flex flex-col font-elegant-typewriter">
            {/* Artist Image Section with location in top right */}
            <div className="relative w-full overflow-hidden" style={{ height: "220px" }}>
              {imageError ? (
                <div className="absolute inset-0 flex items-center justify-center bg-gray-800">
                  <Music className="h-16 w-16 text-[#8b7355]" />
                </div>
              ) : (
                <Image
              ...
              <button
                onClick={onClose}
                className="absolute top-4 left-4 z-10 w-8 h-8 bg-[#8b7355] bg-opacity-50 rounded-full flex items-center justify-center"
              >
                <svg
              ...
              <div className="absolute top-4 right-4 z-10 flex items-center">
                <MapPin className="h-4 w-4 text-[#8b7355] mr-1" />
                <span className="text-[#8b7355] text-sm">{location}</span>
              </div>

              {/* Artist name overlay - positioned directly on the image */}
              <div className="absolute bottom-0 left-0 right-0 bg-[#9b8b78] py-2">
                <h2 className="text-xl font-bold text-[#f5f1e8] text-center">{artistName}</h2>
              </div>
            </div>
            ...
            <div className="px-4 py-2">
              ...
              <div className="mb-3">
                ...
                <p className="text-[#6b5a47] text-[15px] leading-relaxed">{bio}</p>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex justify-center space-x-6">
                  <div className="flex items-center">
                    <span className="text-[#8b7355] mr-1">🎸</span>
                    <span className="text-[#8b7355] text-sm">Guitar</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-[#8b7355] mr-1">🎹</span>
                    <span className="text-[#8b7355] text-sm">Piano</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-[#8b7355] mr-1">🎤</span>
                    <span className="text-[#8b7355] text-sm">Vocals</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-3">
                <Button
                  ...
                  className="w-full bg-[#f5f1e8] hover:bg-[#ede5d8] text-[#8b7355] border border-[#8b7355] py-3 rounded-full text-base font-medium"
                >
                  Send a Tip
                </Button>
              </div>
